...
namespace Frank_SO_Demand_Report
{
    ...
    public class Report
    {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        foreach (DataRow row in sorted_calculated_sale.Rows) 
                        {
                            ...
                            if (count > required_quantity - inventory)
                            {
        ...
        {            
            ...
            if (replenishment_system == "Fertigungsauftrag" && calculated_item["Quantity able to Produce"].ToString() == "")
            {
                ...
                return (double)calculated_item["Quantity able to Produce"];
        }
