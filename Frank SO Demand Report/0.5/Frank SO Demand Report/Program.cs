    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < Calculated_Item.Rows.Count; i++)
            {
                ...
                try
                {
                    if (item["No."].ToString() == "AF0231")
                        Debug.WriteLine("At AF0231");
        ...
        private static void rekursiveItemData(DataRow parentRow, double RequiredQuantity, DataRow sales_line)
        {
            ...
            #region Debug Control
            if (sales_line["Document No."].ToString() == "VB15236" && itemNo == "AK0389")
                Debug.WriteLine("At VB15236");
            ...
            #region Required Quantity for current sales line
