...
namespace Server
{
    class Program
    {
        ...
        {   
            ...
            Parent_Child_Item_File = File.ReadAllBytes(Parent_Child_Item_Path);
                ...
                if (bytesRead > 0) 
                {
                    ...
                    switch (message) 
                    {
                        case "requesting information":
                            message = "Calculated_Item_Size:" + Calculated_Item_File.Length.ToString() + "|Calculated_Sale_Size:" + Calculated_Sale_File.Length.ToString() + "|Parent_Child_Item_Size:" + Parent_Child_Item_File.Length.ToString();
                        ...
                        case "requesting Calculated_Sale":
                            ...
                            break;
                        case "requesting Parent_Child_Item":
                            stream.Write(Parent_Child_Item_File, 0, Parent_Child_Item_File.Length);
                            break;
                    }
                }
            }
