    ...
    public class Report
    {
            ...
            if (itemNo != "")
            {
                ...
                if (ParentNo != null)
                {
                    ...
                    catch (ConstraintException)
                    {
                        ...
                        dr["Quantity"] = (double)dr["Quantity"] + RequiredQuantity;
                    }
                }
        ...
        private void FillCalculatedItem() 
        {
            for (int i = 0; i < Calculated_Item.Rows.Count; i++)
            {
                ...
                try
                {
                    if ((double)dr["Required Quantity"] <= 0)
                    {
                    ...
                    else
                    {
                        ...
                        double inventory = (double)dr["Inventory"];
                        double required_quantity = (double)dr["Required Quantity"];
                        double sales_order = getQuantityInSalesOrder(item);
                        double purchase_order = (double)dr["Purchase Order"];
                        double prod_component = getQuantityInComponent(item);
                        double prod_order = getQuantityProdOrder(item);
                        double qty_on_requisition = (double)dr["Qty. on Requisition"];
                        ...
                        dr["Missing Quantity"] = missing_quantity;
