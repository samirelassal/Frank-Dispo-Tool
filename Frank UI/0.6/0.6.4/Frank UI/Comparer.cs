...
namespace Frank_UI
{
    ...
    class InSalesLieferterminDateTimeAscendingComparer : IComparer
    {
        int IComparer.Compare(object x, object y)
        {
            var line1 = (InSales)x;
            var line2 = (InSales)y;
            DateTime i1 = DateTime.Parse(line1.Liefertermin);
            DateTime i2 = DateTime.Parse(line2.Liefertermin);
            if (i1 > i2)
                return 1;
            if (i1 < i2)
                return -1;
    ...
    class InSalesLieferterminDateTimeDescendingComparer : IComparer
    {
        int IComparer.Compare(object x, object y)
        {
            var line1 = (InSales)x;
