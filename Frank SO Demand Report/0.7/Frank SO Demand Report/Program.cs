...
namespace Frank_SO_Demand_Report
{
    ...
    class Program
    {
        ...
        /// 
        /// </summary>
        /// <param name="args">print_report: no | yes</param>
        static void Main(string[] args)
        {
            ...
            if (args.Length > 0) 
            {
                if (args[0] == "print_report:") 
                {
                    switch (args[1]) 
                    {
                        case "no": print_report = false; break;
                    }
                }
            }
        ...
        private static double getUnitFactor(object ItemNo, object Unit) 
        {
        ...
        static Color Contrast = new Color(230, 230, 230);
